...
<title>Co-ordinator's Page</title>
<style type="text/css">
	body {
...
<body>
	<b style="color: teal;"><em><font size="6">Welcome, <%
	...
	<form action="CoordinatorServlet" method="post">
	<p>
		<input type="radio" name="category" value="0" checked>Schedule Meeting 
		<br> <input type="radio" name="category" value="1">Schedule Event 
		<br> <input type="radio" name="category" value="2">Post Feed 
		<br> <input type="radio" name="category" value="3">Open Registration 
		<br> <input type="radio" name="category" value="4">Close Registration
	</p>
	<p>
