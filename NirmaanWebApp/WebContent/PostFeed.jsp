...
<body>
	<div class="container">
	<form action="CoordiOptionsServlet" method="post">
	<fieldset>
	<p style="font: bold; font-size:200%; ; color: olive;">New Feed</p>
	<input type="text" name="FeedHead"><br>
	<input type="text" name="FeedBody"><br><br><br>
	<input type="submit" value="Post" id="0">
	</fieldset>
	<br>
		<br>
		...
		<br>
		<br>
		<center><input type="submit" value="Print Feed" id="1"></center>
		<br>
		<br>
		<center style="color: maroon; font: italic; font-size: xx-large;">OR</center>
		<br>
		<br>
		<center><input type="submit" value="Subcribe to a Feed" id="2"></center>
	</form>
	</div>
</body>
</html>