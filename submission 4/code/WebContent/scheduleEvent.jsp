...
<body>
	...
	<form action="MeetingServlet" method="post">
		<fieldset>
			<legend> <b><font size="4" style="color: olive;">Schedule new Event</font></b> </legend>
			
			<label>Name:</label>
			<input type="text" name="name"><br>
			<label>Start Date:</label><input type="text" value="YYYY" name="s_year">:<input type="text" value="MM" name="s_month">:<input type="text" value="DD" name="s_date"><br>
			<label>End Date:</label><input type="text" value="YYYY" name="e_year">:<input type="text" value="MM" name="e_month">:<input type="text" value="DD" name="e_date"><br>
			
			<p><input type="submit" value="Schedule" id="0"></p>
		</fieldset>
		<br>
		<br>
		<center style="color: maroon; font: italic; font-size: xx-large;">OR</center>
		<br>
		<br>
		<center><input type="submit" value="Get List of Scheduled Events" id="1"></center>
	</form>
	</div>
</body>
</html>