...
public class NirmaanApp {
	...
	public static void main(String[] args) {
		...
		// Feed f = new Feed("Test Feed",
		// "This feed is only for testing purpose!!!", db);
		//
		...
		cod1.scheduleEvent("Joy of Giving", d, d2, db);
		cod1.scheduleActivity(e, "Streetplay", "venue2", "Joy of Giving",
				new Date(2017, 7, 19), new Time(11, 0, 0), new Time(12, 0, 0),db);// boolean temp = cod1.scheduleMeeting(new Date(2014,11,13),
					// new Time(20,10,00), "B-Dome", db);
