...
<body>
	...
	<div id="login">
		<form action="CoordinatorServlet" method="post">
			<fieldset>
				<p>
					<input type="radio" name="category" value="0" checked>Schedule
					Meeting <br> <input type="radio" name="category" value="1">Schedule
					Event <br> <input type="radio" name="category" value="2">Post
					Feed <br> <input type="radio" name="category" value="3">Open
					Registration <br> <input type="radio" name="category"
						value="4">Close Registration
				</p>
				<p>
